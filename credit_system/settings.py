...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            ...
            'USER': DATABASE_URL.split(':')[1].split('@')[0].replace('//', ''),
...
# File paths for data ingestion
CUSTOMER_DATA_PATH = os.environ.get('CUSTOMER_DATA_PATH', '/data/customer_data.xlsx')
LOAN_DATA_PATH = os.environ.get('LOAN_DATA_PATH', '/data/loan_data.xlsx')
